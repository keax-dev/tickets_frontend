// Verifies the ticket creation store loads active categories, creates tickets, and reports failures.
import { TestBed } from '@angular/core/testing';
import { Router } from '@angular/router';
import { of, throwError } from 'rxjs';
import { vi } from 'vitest';
import { Category, CreateTicketRequest, TicketDetail } from '../../../../shared/models/api.models';
import { TicketApiService } from '../../services/ticket-api.service';
import { TicketCreateStore } from '../../stores/ticket-create.store';

describe('TicketCreateStore', () => {
  // Router spy and API fixtures used across the category loading and ticket creation flows.
  const routerMock = {
  ...
  // Service spy references and store instance resolved through Angular DI.
  ...
  // Recreates the store with isolated router and API spies before each test.
  beforeEach(() => {
    vi.clearAllMocks();
