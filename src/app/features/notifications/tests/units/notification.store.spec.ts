// Verifies notification pagination, refresh-after-mutation behavior, and mutation error handling.
...
describe('NotificationStore', () => {
  // Response fixtures that model the initial list and the refreshed read state.
  ...
  // Service spy references and store instance shared across the suite.
  ...
  // Recreates the store with isolated notification API spies before each scenario.
  beforeEach(() => {
