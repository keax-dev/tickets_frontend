// Verifies the shared problem-details helpers prioritize actionable messages and normalize HTTP errors.
import { HttpErrorResponse, HttpHeaders } from '@angular/common/http';
import {
  normalizeProblemDetails,
  resolveProblemDetailsFieldErrors,
  resolveProblemDetailsMessage,
} from '../../utils/resolve-problem-details-message';

describe('resolveProblemDetailsMessage', () => {
  // Representative backend and transport failures used by the helper assertions below.
